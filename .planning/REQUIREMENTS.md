...
- [x] **BITMAP-01**: Library converts a PNG or BMP image to a packed 1-bit binary buffer matching a given `DisplaySpec`'s dimensions and bit order
...
- [x] **DOCS-01**: ExDoc API docs generated with getting-started, hardware setup, and display model reference guides
